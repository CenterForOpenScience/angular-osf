...
import { AddonModel, AddonTerm, AuthorizedStorageAccountModel } from '@shared/models';
...
export class AddonTermsComponent {
  addon = input<AddonModel | AuthorizedStorageAccountModel | null>(null);
  ...
  private getAddonTerms(addon: AddonModel | AuthorizedStorageAccountModel): AddonTerm[] {
