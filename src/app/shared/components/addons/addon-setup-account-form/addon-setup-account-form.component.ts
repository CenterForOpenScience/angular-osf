...
import { AddonForm, AddonModel, AuthorizedAddonRequestJsonApi, AuthorizedStorageAccountModel } from '@shared/models';
...
export class AddonSetupAccountFormComponent {
  ...
  addon = input.required<AddonModel | AuthorizedStorageAccountModel>();
