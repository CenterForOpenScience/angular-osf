...
import { AuthorizedStorageAccountModel, ConfiguredStorageAddonModel } from '@shared/models';
...
export class AddonDialogService {
  ...
  openConfirmAccountConnectionDialog(selectedAccount: AuthorizedStorageAccountModel): Observable<{ success: boolean }> {
