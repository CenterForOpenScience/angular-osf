...
export class FileDetailComponent {
  ...
  private readonly actions = createDispatchMap({
    ...
    getFileResourceInstitutions: GetFileResourceInstitutions,
  ...
  resourceInstitutions = select(FilesSelectors.getInstitutions);
  ...
  private readonly metaTagsData = computed(() => {
    ...
    return {
      ...
      description:
        ...
        this.translateService.instant(_('files.metaTagDescriptionPlaceholder')),
      ...
      institution: this.resourceInstitutions()?.map((institution) => institution.name),
    ...
    this.route.params
      ...
      .subscribe(() => {
        ...
        if (this.resourceId && this.resourceType) {
          ...
          this.actions.getFileResourceInstitutions(this.resourceId, this.resourceType);
