...
describe('ProfileComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        ...MockComponents(ProfileSearchComponent, EducationHistoryComponent, EmploymentHistoryComponent),
      ],
      providers: [
  ...
  it('should render search component', () => {
    const searchComponent = fixture.debugElement.query(By.directive(ProfileSearchComponent));
