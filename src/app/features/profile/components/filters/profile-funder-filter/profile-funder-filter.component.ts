...
import { ProfileResourceFiltersSelectors, SetFunder } from '../../profile-resource-filters/store';

@Component({
  selector: 'osf-profile-funder-filter',
  imports: [Select, FormsModule],
  templateUrl: './profile-funder-filter.component.html',
  styleUrl: './profile-funder-filter.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProfileFunderFilterComponent {
  readonly #store = inject(Store);

  protected funderState = this.#store.selectSignal(ProfileResourceFiltersSelectors.getFunder);
  protected availableFunders = this.#store.selectSignal(ProfileResourceFiltersOptionsSelectors.getFunders);
